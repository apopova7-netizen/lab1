...
##Decision Rules:
##### n ≤ 100	SORT_SHELL	
##### n > 100 and array is sorted	SORT_TIMSORT	
##### n > 100 and type is NOT int	SORT_TIMSORT	
##### n > 100, type is int, not sorted	SORT_COUNTING	
For CountingSort, the function returns minimum and maximum values through outMinVal and outMaxVal
